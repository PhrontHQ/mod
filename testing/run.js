...
global.createJavaScriptContext = function createJavaScriptContext() {
    ...
    ["Object", "String", "Number", "RegExp", "Array", "Boolean"].forEach(function (key) {
...
global.addMontageMetadataToProto = function (objectName, moduleId, proto) {
    Object.defineProperty(proto, "_montage_metadata", {
        value: { moduleId: moduleId, objectName: objectName, isInstance: false },
        enumerable: false,
    });
};
...
exports.run = function run(suiteRequire, modules) {
    ...
    return Promise.all(modules.map(suiteRequire.deepLoad))
        .then(function () {
