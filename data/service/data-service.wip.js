    ...
    */
        ...
        */
        ...
        _resetDataEvent: {
            value: function(dataEvent) {
                //The rest is overriden every time
                //For willSave...
                delete dataEvent["_composedPath"];

                //For change event... Needs a different reset function per type...
                delete dataEvent["transaction"];
        ...
        dispatchDataEventTypeForObject: {
            value: function (eventType, object, detail, composedPath) {
                /*
            ...
            */
                if (object.dispatchEvent) {
                    ...
                    if(composedPath && dataEvent.setComposedPath) {
     ...
     */
        ...
        registerChangedDataObject: {
            value: function (dataObject, _changedDataObjects, _objectDescriptorsWithChanges) {
                var objectDescriptor = this.objectDescriptorForObject(dataObject),
                    changedDataObjects,
                    value;
                ...
                changedDataObjects = _changedDataObjects ? _changedDataObjects : this.changedDataObjects;
                ...
                (_objectDescriptorsWithChanges ? _objectDescriptorsWithChanges : this.objectDescriptorsWithChanges).add(objectDescriptor);
            },
        },
        ...
        /* 
            This isn't used right now, but when we start using the undo manager
            we probably will need to invoke it
        */
     ...
     */
        ...
        _registerDataObjectChangesFromEvent: {
            value: function (
                ...
                var dataObject = changeEvent.target,
                    transaction = changeEvent.transaction,
