 ...
 */
exports.Select = class Select extends Control {
    constructor() {
        super();
    ...
    handleSelectedIndexesRangeChange(plus, minus, index) {
        if (this.needsDraw === false) {
            this.needsDraw = this._synching || !this._fromInput;
        }
    }

    _setContentControllerSelectedIndexes(selectedIndexes) {
    ...
    handleSelectionRangeChange(plus, minus, index) {
    ...
    handleContentRangeChange(plus, minus, index) {
        this.needsDraw = true;
    }
    ...
    */
    ...
    _getSelectedOptionsIndexes(selectEl) {
        var options = selectEl.querySelectorAll("option");
    ...
    static {
        Control.defineProperties(Select.prototype, {
