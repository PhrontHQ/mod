...
const DocumentResources = Montage.specialize(
    {
        _SCRIPT_TIMEOUT: {
            value: 5000,
        },
                            ...
                            if (!(cssRules[iStart] instanceof CSSLayerBlockRule)) {
                                ...
                                if (!(cssRules[iStart] instanceof CSSScopeRule) && this.automaticallyAddsCSSScope) {
                                    ...
                                    let scopeRule = stylesheet.cssRules[iStart],
                                        ...
                                        match,
                                        scopeSelectorRegExp = this._scopeSelectorRegExp,
                                        scopeSelector;
        ...
        getInstanceForDocument: {
            value: function (_document) {
                ...
                if (!documentResources) {
                    documentResources = _document.__montage_resources__ = new DocumentResources().initWithDocument(
                        _document,
                    );
                }
