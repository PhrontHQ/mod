...
//We shouldn't need that but it's somehow executed several times im montage tests
if(!Array.nativeFrom ) {
    Array.nativeFrom = Array.from;
}
// else {
//     console.debug("shim-array.js executed again");
// }
...
define("clone", function (depth, memo) {
    ...
    //For a depth of 1, this should just return this.slice();
