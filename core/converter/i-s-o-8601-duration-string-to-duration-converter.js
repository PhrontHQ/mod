 ...
 * @classdesc Converts a range of duration strings where weeks and other units are combined, and strings with
 ...
 * 
 * An example of a range of durations is shipping time. For example, 2-4 weeks is: [P2W,P4W]
 *
 ...
 * 
 * The range format is postgreSQL range formats: https://www.postgresql.org/docs/9.4/rangetypes.html
 */
var ISO8601DurationStringToDurationConverter = exports.ISO8601DurationStringToDurationConverter = Converter.specialize({
    ...
    /**
     * Converts a Range of ISO 8601-2 duration strings to a range of Duration.
     * @function
     * @param {string} v The string to convert.
     * @returns {Range} The Range converted from the string.
     */
    convert: {
        value: function (v) {
    ...
    /**
     * Reverts the specified Range to a range string of ISO 8601-2 formatted durations.
     * @function
     * @param {Range} v The specified range.
     * @returns {string}
     */
    revert: {
        value: function (v) {
