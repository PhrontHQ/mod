 ...
 * @extends Montage
 */
exports.PropertyValidationRule = Montage.specialize(
    /** @lends PropertyValidationRule# */ {
        /**
        ...
        evaluateRule: {
            value: function (objectInstance) {
                if (this._propertyValidationEvaluator === null) {
                    var propertyValidationSemantics = new PropertyValidationSemantics().initWithObjectDescriptor(
