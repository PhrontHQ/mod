...
describe("spec/mod/template-spec", function () {
    var template,
    ...
    describe("initialization", function () {
        ...
        it("should resolve relative image's URL", function (done) {
            var moduleId = "spec/mod/template/template-relative-image.html",
                expectedResult = {
                    "src" : URL.resolve(baseURI, "spec/mod/template/sample-image.jpeg")
                }
    ...
    describe("markup", function () {
        ...
        it("should add a node to the template without collisions", function () {
            var html = require("spec/mod/template/modification.html").content,
                htmlModification = require("spec/mod/template/modification-elements.html").content,
                htmlDocument = document.implementation.createHTMLDocument(""),
                collisionTable,
                node,
                reference;
        ...
        it("should replace a node into the template and resolve any relative Urls", function (done) {
            var moduleId = "spec/mod/template/modification.html",
                htmlModification = require("spec/mod/template/template-relative-image.html").content,
                htmlDocument = document.implementation.createHTMLDocument(""),
                expectedResult = {
                    "src" : URL.resolve(baseURI, "spec/mod/template/sample-image.jpeg")
                };
    ...
    describe("instantiation", function () {
        ...
        it("should instantiate an empty template", function (done) {
            var html = require("spec/mod/template/empty-template.html").content;
        ...
        it("should have the correct child components", function (done) {
            var html = require("spec/mod/template/component-tree-template.html").content;
    ...
    describe("delegate methods", function () {
        ...
        it("should call deserializedFromTemplate", function (done) {
            var html = require("spec/mod/template/delegate-methods-template.html").content,
                instances = {
        ...
        it("should not call deserializedFromTemplate on null values", function (done) {
            var html = require("spec/mod/template/delegate-methods-null-template.html").content;
        ...
        it("should call templateDidLoad on owner not used in serialization", function (done) {
            var html = require("spec/mod/template/delegate-methods-no-owner-template.html").content;
        ...
        it("should not call templateDidLoad on external objects", function (done) {
            var html = require("spec/mod/template/delegate-methods-template-external.html").content;
    ...
    describe("external objects", function () {
        it("should have access to application object", function (done) {
            var html = require("spec/mod/template/external-objects-template.html").content,
                instances = {
                    one: {}
                };
    ...
    describe("template resources", function () {
        it("should load all scripts except montage serialization", function (done) {
            var html = require("spec/mod/template/resources-template.html").content,
            ...
            createPage("spec/mod/template/page.html").then(function (page) {
                ...
                .then(function () {
                    ...
                    .then(function () {
                        expect(page.ModTemplateResourceLoadCount).toBe(1);
        ...
        it("should load all scripts in two different documents in serial", function (done) {
            ...
            Promise.all([
                createPage("spec/mod/template/page.html"),
                createPage("spec/mod/template/page.html")])
            .then(function (pages) {
                var page1 = pages[0],
                    page2 = pages[1];
                ...
                .then(function () {
                    ...
                    .then(function () {
                        ...
                        .then(function () {
                            expect(page1.ModTemplateResourceLoadCount).toBe(1);
                            expect(page2.ModTemplateResourceLoadCount).toBe(1);
    ...
    describe("template parameters", function () {
        it("should find the star parameter", function (done) {
            var html = require("spec/mod/template/template-star-parameter.html").content;
        ...
        it("should find all parameters", function (done) {
            var html = require("spec/mod/template/template-parameters.html").content;
        ...
        it("should not fail when star and other parameters were declared", function (done) {
            var html = require("spec/mod/template/template-parameters-error.html").content;
        ...
        it("should fail when the same parameter is declared more than once", function (done) {
            var html = require("spec/mod/template/template-duplicate-parameters.html").content;
    ...
    describe("expanding template parameters", function () {
        ...
        it("should expand a parameter with non-colliding element", function (done) {
            var parametersHtml = require("spec/mod/template/template-star-parameter.html").content,
                argumentsHtml = require("spec/mod/template/template-arguments.html").content;
        ...
        it("should expand multiple parameters with non-colliding element", function (done) {
            var parametersHtml = require("spec/mod/template/template-parameters.html").content,
                argumentsHtml = require("spec/mod/template/template-arguments.html").content;
        ...
        it("should resolve a direct template property alias", function (done) {
            var parametersHtml = require("spec/mod/template/template-properties-parameters.html").content,
                argumentsHtml = require("spec/mod/template/template-arguments.html").content,
                serialization;
            ...
            require.loadPackage("spec/package-a").then(function (pkg1) {
                return require.loadPackage("spec/package-b").then(function (pkg2) {
                    ...
                    .then(function (template1) {
                        return Template.getTemplateWithModuleId("ui/main.mod/main.html", pkg2)
                        .then(function (template2) {
